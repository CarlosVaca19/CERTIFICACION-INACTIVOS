...
def modify():
    ...
    # Obtener el número de certificación del formulario
    numero_certificacion = replacements.get("Número de Certificación", "certificacion_sin_numero")
    ...
    # Descargar el archivo con el número de certificación como nombre
    return send_file(modified_file, as_attachment=True, download_name=f'{numero_certificacion}.docx')
